  ...
  return (
    <div className='md:w-full min-h-screen bg-[#2c3e50]'>
        <div className='w-10/12 h-auto md:w-10/12 py-20 mx-auto flex flex-col items-center'>
            ...
            <div className="w-32 cursor-pointer justify-center rounded-xl text-white mt-10 flex items-center h-7 bg-[#1abc9c] hover:opacity-50" onClick={() => router.push("https://drive.google.com/file/d/1IEOMzQwxoeXQ2Pc7qQ3IFQhiu-4jfLXz/view?usp=sharing")}>
      Download CV
    </div>
        </div>
    </div>
